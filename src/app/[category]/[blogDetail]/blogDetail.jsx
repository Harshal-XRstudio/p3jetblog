      ...
      {blogDetails && (
        <>
          ...
          <article className="max-w-5xl mx-auto px-4 py-12">
                    ...
                    <TooltipTrigger asChild>
                      <span className="inline-flex items-center justify-center">
                        <button
                          ...
                          className="text-gray hover:text-blue-400 dark:hover:text-blue-500 hover:border-blue-400 dark:hover:border-blue-500 transition-colors duration-300 cursor-pointer border rounded-lg p-1"
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <span className="inline-flex items-center justify-center">
                        <Link
                          target="_blank"
                          className="text-gray hover:text-[#0077B5] transition-colors duration-300 inline-flex items-center justify-center"
            ...
            {/* <nav
              className="mt-12 pt-8 border-t border-black/20 dark:border-gray-500"
              aria-label="Breadcrumb navigation">
              <Link
                href="/"
